...
<body>
	...
	// phpinfo();
	//php is a losely type, backend (serve-side) scripting language
	...
	// String Interpolation - A String has quoatation marks! Single quote does not interpolate variables
