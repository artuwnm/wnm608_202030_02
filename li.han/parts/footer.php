<div class="container">
    <div class="grid gap" style="background-color: transparent;">
      ...
      <div class="col-md-4 col-sm-12">
            ...
            <ul>
              ...
              <li><a href="article3">Sitemap</a></li>
      ...
      <div class="col-md-3 col-sm-12">
            ...
            <ul>
              ...
              <li><a href="article2">Returns & Refunds</a></li>
              <li><a href="article2">Terms & Conditions</a></li>
            </ul>
    ...
    <br>
    <p class="text-align-center col-md-12">  © Copyright 2020 GLOWING BEAUTY </p>
    <br>
  </div>