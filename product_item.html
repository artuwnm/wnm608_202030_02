		...
		<ul class="ctas display-flex">
			<li class="search">
				<a href="#" class="search-icon">
					<img src="img/search.png" width="30px" height="30px" alt="Search">
				</a>
			</li>
			<li>
				<a href="bag.php" class="bag-icon">
					<img src="img/bag.png" width="30px" height="30px" alt="Cart">
				</a>
			</li>
		</ul>
	</div>
		...
		<div class="grid gap">
			<div class="col-xs-12 col-md-6 col-lg-4">
				<div class="product-figure card light">
					<img src="img/soap.jpg" alt="Soap 1">
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-4">
				<div class="product-figure card light">

					<img src="img/soap.jpg" alt="Soap 2">
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-4">
				<div class="product-figure card light">

					<img src="img/soap.jpg" alt="Soap 3">
				</div>
			</div>
		</div>
	</div>
